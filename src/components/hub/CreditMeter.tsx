...
export default function CreditMeter() {
  ...
  const total = usage?.totalCredits ?? HUB_PLAN.monthlyCredits;
  ...
  return (
    <BentoCard variant="neumorphic" className="flex flex-col" glowColor="rgba(255, 106, 0, 0.04)">
      <div className="flex items-center gap-2 px-5 py-4 border-b border-white/40">
        ...
        <span className="text-[13px] font-black uppercase tracking-wider text-[#0f172a]">Créditos do Plano</span>
          ...
          <div className="space-y-2">
            <p className="text-[12px] font-semibold leading-snug" style={{ color: barColor }}>
              {isExhausted
                ...
                : `Você já usou ${Math.round(ratio * 100)}% dos créditos deste ciclo.`}
            </p>
            <button
              type="button"
