...
const VideoPlayerPro: React.FC<VideoPlayerProProps> = ({ src }) => {
  ...
  return (
    <motion.div
      ref={containerRef}
      className="relative w-full max-w-5xl mx-auto overflow-hidden rounded-xl bg-slate-950"
    ...
    >
      ...
      <AnimatePresence>
        {showControls && (
          <motion.div
            className="absolute bottom-4 left-1/2 transform -translate-x-1/2 w-[95%] backdrop-blur-xl bg-white/10 rounded-2xl p-3 flex flex-col gap-3 z-30"
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <Popover>
                  ...
                  <PopoverContent className="w-32 bg-slate-900/90 border-slate-700/50 p-3">
                    <Slider
                      value={[volume * 100]}  
              ...
              <div className="flex items-center gap-2">
                ...
                <Popover>
                  ...
                  <PopoverContent className="bg-slate-900/95 border-slate-700/50 w-40 p-3">
                    <div className="flex flex-col gap-2">
                      ...
                      <span className="text-xs font-semibold text-slate-400 mt-2">Captions</span>
                      <Button variant="outline" size="sm" className="w-full text-xs text-white">
                        Off
                      </Button>
                    </div>
                  </PopoverContent>
