      ...
      <section className="mx-auto max-w-[1260px] px-5 pb-14 pt-5 md:px-8">
        ...
        {data.process?.length ? (
          <section className="mt-8 rounded-[26px] border border-[#e7ecf4] bg-white p-6 shadow-[0_14px_34px_rgba(12,22,38,0.05)] md:p-8">
            <h3 className="text-[30px] font-black leading-tight text-[#0f1730]">Como funciona na prática</h3>
        ...
        {data.resources?.length ? (
          <section className="mt-8 rounded-[26px] border border-[#e7ecf4] bg-white p-6 shadow-[0_14px_34px_rgba(12,22,38,0.05)] md:p-8">
            <h3 className="text-[30px] font-black leading-tight text-[#0f1730]">Trilhas e recursos recomendados</h3>
