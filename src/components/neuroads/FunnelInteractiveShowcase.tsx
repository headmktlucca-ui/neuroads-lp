...
const FUNNEL_STEPS: FunnelStep[] = [
  ...
  },
  {
    ...
    description: 'Quando o lead chega, o tempo de resposta é crucial. O agente SDR realiza uma conversa de qualificação objetiva via WhatsApp em menos de 2 minutos.',
  ...
  },
  {
    ...
    description: 'Após a qualificação, os dados são sincronizados no CRM e a automação de processos cuida da integração de chaves e alertas sem intervenção humana.',
