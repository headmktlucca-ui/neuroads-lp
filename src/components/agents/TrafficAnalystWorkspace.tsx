            ...
            {operationalMode === 'real' ? (
              <div className="rounded-xl border border-[#FF6B00]/20 bg-[#FF6B00]/5 p-4 text-xs space-y-2 mb-4">
                ...
                <ul className="list-disc pl-4 space-y-1 text-text-muted">
                  <li><strong>Google Ads:</strong> Para extração de campanhas de pesquisa e PMax ({connectors.googleAds.isActive ? 'Conectado ✅' : 'Não conectado ⚠️'})</li>
                  <li><strong>Meta Ads:</strong> Para extração de campanhas de Feed, Stories e Reels ({connectors.metaAds.isActive ? 'Conectado ✅' : 'Não conectado ⚠️'})</li>
                  <li><strong>LinkedIn Ads:</strong> Para extração de campanhas corporativas B2B ({connectors.linkedinAds.isActive ? 'Conectado ✅' : 'Não conectado ⚠️'})</li>
                </ul>
              </div>
            ) : (
