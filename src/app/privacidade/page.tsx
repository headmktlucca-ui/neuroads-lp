    ...
    <LegalLayout>
      <motion.div {...fadeUp}>
        ...
        <p className="text-text-2 text-[0.95rem] leading-relaxed mb-12">
          Sua privacidade é fundamental para a NeuroAds. Esta política descreve como coletamos, usamos e protegemos suas informações quando você utiliza nossa plataforma e serviços de consultoria estratégica.
        </p>
        ...
        <section className="space-y-12">
          ...
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside text-text-3 text-[0.85rem] space-y-2 ml-4">
          ...
          {/* 7. Contato */}
          <div className="mt-16 p-8 bg-white/[0.03] border border-white/[0.08] rounded-2xl">
            <h3 className="text-text-1 font-bold mb-4 italic">Dúvidas sobre sua privacidade?</h3>
          ...
          <p className="text-text-4 text-[0.7rem] pt-12 text-center uppercase tracking-widest">
