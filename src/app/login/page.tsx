    ...
    <div className="h-screen max-h-screen flex bg-transparent relative overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center bg-transparent p-4 sm:p-6 lg:p-8 relative z-10 h-full overflow-y-auto">
        <div className="w-full max-w-[540px] p-6 sm:p-8 rounded-2xl border border-slate-300 bg-white shadow-[6px_6px_12px_#c8d0e7,-6px_-6px_12px_#ffffff]">
          ...
          <div className="mb-8">
            <h1 className="text-[28px] font-black text-slate-900 leading-tight">Bem-vindo de volta</h1>
            <p className="mt-1.5 text-[14px] text-slate-900/45 font-medium">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 h-11 rounded-xl border border-slate-300 bg-slate-50 hover:bg-slate-100 transition-all text-[14px] font-semibold text-slate-900 disabled:opacity-50 disabled:cursor-not-allowed"
          >
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label className="text-[11px] font-black uppercase tracking-wider text-slate-900/40">Senha</label>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  required
                  className="w-full h-11 rounded-xl border border-white/[0.10] bg-slate-50 pl-10 pr-11 text-[14px] text-slate-900 placeholder:text-slate-900/20 focus:outline-none focus:border-[#FF6A00]/50 focus:ring-1 focus:ring-[#FF6A00]/30 transition-all"
                />
                <button
                  type="button"
          ...
          <p className="mt-6 text-center text-[13px] text-slate-900/35">
            Não tem uma conta?{' '}
          ...
          <p className="mt-4 text-center text-[11px] text-slate-900/20 leading-relaxed">
            Ao entrar, você concorda com nossos{' '}
            <a href="/termos" className="underline hover:text-slate-900/40 transition-colors">Termos</a>{' '}
            e{' '}
