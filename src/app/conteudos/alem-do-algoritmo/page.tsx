  ...
  return (
    <main className="relative overflow-hidden bg-white text-[#0f172a]">
      ...
      <div className="relative z-10">
        ...
        <section className="wrap pb-8 pt-14 sm:pt-18">
          ...
          <div className="relative overflow-hidden rounded-[30px] border border-[#e6edf6] bg-white/92 p-8 shadow-[0_28px_60px_rgba(8,22,44,0.1)] sm:p-10">
            <div className="pointer-events-none absolute -right-20 -top-24 h-64 w-64 rounded-full bg-[#ff6a00]/12 blur-3xl" />
            <div className="pointer-events-none absolute -bottom-24 left-14 h-52 w-52 rounded-full bg-[#0f1d3f]/12 blur-3xl" />
            ...
            <div className="relative z-10">
              ...
              <p className="mt-6 max-w-3xl text-lg leading-relaxed text-[#40506a]">
                Estratégia aplicada para empresários que precisam de crescimento previsível. Aqui cada conteúdo traduz SEO + GEO, IA agêntica e
                performance para impacto real no caixa.
              </p>
